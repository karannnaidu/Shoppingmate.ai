"use strict";(()=>{var et=Object.defineProperty;var tt=(e,n,t)=>n in e?et(e,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[n]=t;var g=(e,n,t)=>tt(e,typeof n!="symbol"?n+"":n,t);function A(){let e=globalThis,n=e.SpeechRecognition??e.webkitSpeechRecognition;if(!n)return null;let t=new n;t.continuous=!0,t.interimResults=!1,t.lang="en-US";let o=!1,i=[],r=[];return t.onresult=a=>{for(let s=0;s<a.results.length;s+=1){let c=a.results[s];if(c?.isFinal){let d=c[0]?.transcript?.trim();if(d)for(let u of i)u(d)}}},t.onerror=a=>{for(let s of r)s(String(a?.error??"unknown"))},t.onend=()=>{o=!1},{start:()=>{if(!o){o=!0;try{t.start()}catch{}}},stop:()=>{if(o){o=!1;try{t.stop()}catch{}}},onFinal:a=>{i.push(a)},onError:a=>{r.push(a)},isActive:()=>o}}function $(){let e=globalThis.speechSynthesis;if(!e)return{speak:async()=>{},cancel:()=>{},available:()=>!1};function n(){if(!e)return null;let t=e.getVoices();return t.find(o=>o.lang.startsWith("en-")&&o.default)??t.find(o=>o.lang.startsWith("en-"))??t[0]??null}return{speak:t=>new Promise(o=>{let i=new SpeechSynthesisUtterance(t),r=n();r&&(i.voice=r),i.rate=1,i.onend=()=>o(),i.onerror=()=>o(),e.speak(i)}),cancel:()=>e.cancel(),available:()=>!0}}function S(e,n){let t="idle",o=!1,i=[],r=a=>{if(t!==a){t=a;for(let s of i)s(a)}};return{start:()=>{if(t==="idle"){if(o){r("muted");return}e?.start(),r("listening")}},stop:()=>{e?.stop(),n.cancel(),r("idle")},speak:async a=>{t!=="idle"&&(e?.stop(),r("speaking"),await n.speak(a),o?r("muted"):(e?.start(),r("listening")))},setMuted:a=>{o=a,a?(e?.stop(),t==="listening"&&r("muted")):t==="muted"&&(e?.start(),r("listening"))},getState:()=>t,onStateChange:a=>{i.push(a)}}}function nt(e){if(!e||typeof e.type!="string")return!1;switch(e.type){case"navigate":return typeof e.path=="string";case"scroll_to":case"highlight":case"click":case"point_at":case"demo_click":return typeof e.intent=="string";case"cart_add":case"cart_set_qty":return typeof e.sku=="string"&&typeof e.qty=="number";case"open_cart":case"cart_clear":case"checkout_place":case"checkout_state":return!0;case"apply_coupon":return typeof e.code=="string";case"checkout_fill":return!!e.details&&typeof e.details.name=="string"&&typeof e.details.phone=="string"&&typeof e.details.email=="string"&&typeof e.details.address=="string"&&typeof e.details.city=="string"&&typeof e.details.state=="string"&&typeof e.details.pincode=="string"&&(e.details.payment==="cod"||e.details.payment==="prepaid");case"form_fill":return Array.isArray(e.fields)&&e.fields.every(n=>n&&typeof n.field=="string"&&typeof n.value=="string");case"form_read":return e.fields===void 0||Array.isArray(e.fields);default:return!1}}function k(e){return JSON.stringify(e)}function z(e){let n;try{n=JSON.parse(e)}catch{return null}if(!n||typeof n!="object")return null;let t=n;switch(t.type){case"thinking":return{type:"thinking"};case"say":return typeof t.text=="string"?{type:"say",text:t.text}:null;case"say_partial":return typeof t.text=="string"?{type:"say_partial",text:t.text}:null;case"user_text":return typeof t.text=="string"?{type:"user_text",text:t.text}:null;case"cards":return Array.isArray(t.items)?{type:"cards",items:t.items}:null;case"tool_result":return typeof t.toolName!="string"||typeof t.ok!="boolean"?null:{type:"tool_result",toolName:t.toolName,ok:t.ok,summary:typeof t.summary=="string"?t.summary:void 0};case"checkout_redirect":return typeof t.url=="string"?{type:"checkout_redirect",url:t.url}:null;case"cap_warning":return t.reason!=="turns"&&t.reason!=="voice_ms"&&t.reason!=="duration_ms"||typeof t.remaining!="number"?null:{type:"cap_warning",reason:t.reason,remaining:t.remaining};case"end_of_turn":return{type:"end_of_turn"};case"session_closed":return t.reason!=="user"&&t.reason!=="cap"&&t.reason!=="error"?null:{type:"session_closed",reason:t.reason};case"host_action_request":{if(typeof t.callId!="string"||!t.action)return null;let o=t.action;return nt(o)?{type:"host_action_request",callId:t.callId,action:o}:null}case"persona_swap":return typeof t.personaId=="string"?{type:"persona_swap",personaId:t.personaId}:null;case"agent_warmed":return{type:"agent_warmed"};case"agent_ready":return{type:"agent_ready"};default:return null}}var ee="https://cdn.jsdelivr.net/npm",ot="2.7.0",rt="0.3.0",O=null;function it(){return O||(O=import(`${ee}/@livekit/krisp-noise-filter@${rt}/dist/index.mjs`).catch(()=>null),O)}async function at(e){let n=await it();if(!n?.KrispNoiseFilter||n.isKrispNoiseFilterSupported&&!n.isKrispNoiseFilterSupported())return;let t=e.localParticipant.getTrackPublication?.("microphone"),o=t?.audioTrack??t?.track;o?.setProcessor&&await o.setProcessor(n.KrispNoiseFilter())}var w=null;function te(){return w||(typeof globalThis.__SHOPPINGMATE_LIVEKIT_LOADER__=="function"?(w=globalThis.__SHOPPINGMATE_LIVEKIT_LOADER__(),w):(w=import(`${ee}/livekit-client@${ot}/dist/livekit-client.esm.mjs`),w))}function ne(){te().catch(()=>{w=null})}async function oe(e){let n=await te(),t=new n.Room({audioCaptureDefaults:{echoCancellation:!0,noiseSuppression:!0,autoGainControl:!0,channelCount:1}}),o=new Map;t.on("trackSubscribed",r=>{let a=r;if(a.kind!=="audio")return;let s=a.attach();s.style.display="none",document.body.appendChild(s),o.set(r,s)}),t.on("trackUnsubscribed",r=>{let a=o.get(r);a&&(a.remove(),o.delete(r)),r.detach?.()});let i=[];return t.on("activeSpeakersChanged",r=>{let s=(r??[]).some(c=>!c.isLocal);for(let c of i)c(s)}),await t.connect(e.wsUrl,e.token),{setMicEnabled:async r=>{await t.localParticipant.setMicrophoneEnabled(r),r&&at(t).catch(()=>{})},onData:r=>{t.on("dataReceived",a=>{a instanceof Uint8Array&&r(a)})},onAgentSpeaking:r=>{i.push(r)},publishData:r=>t.localParticipant.publishData(r,{reliable:!0}),disconnect:async()=>{for(let r of o.values())r.remove();o.clear(),await t.disconnect()}}}function re(e){let n="idle",t=null,o=null,i=!1,r=!1,a=[],s=[],c=l=>{if(n!==l){n=l;for(let m of a)m(l)}},d=l=>{let m=l instanceof Error?l.message:String(l),h=l instanceof Error?l.name:"",y;/permissions? policy|feature policy/i.test(m)?y="mic_policy_blocked":h==="NotAllowedError"||/denied|permission/i.test(m)?y="mic_denied":h==="NotFoundError"||/no.*microphone|not.*found/i.test(m)?y="mic_unavailable":/connect|network|websocket|timeout|token/i.test(m)?y="connect_failed":y="unknown";for(let P of s)P({code:y,message:m})},u=()=>t?Promise.resolve(t):o||(o=(async()=>{let l=await oe({wsUrl:e.wsUrl,token:e.token,roomName:e.roomName});return l.onData(m=>e.onTranscriptEvent(m)),l.onAgentSpeaking(m=>{i||(m&&(r=!0),r&&c(m?"speaking":"listening"))}),t=l,l})(),o.catch(()=>{o=null}),o);return{warm:()=>{u().catch(l=>console.warn("[voiceModeLiveKit] warm failed",l))},start:()=>{n==="idle"&&(c("connecting"),r=!1,(async()=>{try{let l=await u();await l.setMicEnabled(!i);let m=new TextEncoder().encode(k({type:"start_voice",sessionId:e.sessionId}));await l.publishData(m),i&&c("muted")}catch(l){throw c("idle"),d(l),l}})().catch(l=>{console.warn("[voiceModeLiveKit] start failed",l)}))},stop:()=>{t?.disconnect().catch(()=>{}),t=null,o=null,c("idle")},speak:async()=>{},setMuted:l=>{i=l,t?.setMicEnabled(!l).catch(()=>{}),l?c("muted"):n==="muted"&&c("listening")},getState:()=>n,onStateChange:l=>{a.push(l)},onError:l=>{s.push(l)},signalAgentReady:()=>{r=!0,n==="connecting"&&c(i?"muted":"listening")},publishData:async l=>{t&&await t.publishData(l)}}}function D(e){return e.stack==="web-speech"?S(A(),$()):e.stack==="live-kit"?e.livekit?re(e.livekit):(console.warn("[voiceModeFactory] live-kit stack requires livekit opts; returning null \u2192 caller falls back to chat"),null):null}var ie={start:()=>{},stop:()=>{}};function W(e){if(!e||typeof window>"u")return ie;let n=window.AudioContext??window.webkitAudioContext;if(!n)return ie;let t=null,o=null;return{start(){if(!t)try{t=new n;let i=Math.floor(t.sampleRate*2),r=t.createBuffer(1,i,t.sampleRate),a=r.getChannelData(0),s=0;for(let u=0;u<i;u++){let l=Math.random()*2-1;s=(s+.02*l)/1.02,a[u]=s*3.5}o=t.createBufferSource(),o.buffer=r,o.loop=!0;let c=t.createBiquadFilter();c.type="lowpass",c.frequency.value=900;let d=t.createGain();d.gain.value=.02,o.connect(c).connect(d).connect(t.destination),o.start(),t.resume?.().catch(()=>{})}catch{this.stop()}},stop(){try{o?.stop()}catch{}o=null;try{t?.close()}catch{}t=null}}}var V="sm_visitor_id";function st(){let e=new Uint8Array(8);return(globalThis.crypto??window.crypto).getRandomValues(e),`v_${Array.from(e,t=>t.toString(16).padStart(2,"0")).join("")}`}function ct(){try{let n=localStorage.getItem(V);if(n){let t=JSON.parse(n);if(t?.id&&typeof t.expiresAt=="number")return t}}catch{}let e=document.cookie.match(new RegExp(`(?:^|; )${V}=([^;]+)`));return e?{id:decodeURIComponent(e[1]??""),expiresAt:Date.now()+1}:null}function ae(e){try{localStorage.setItem(V,JSON.stringify(e));let n=Math.floor(6048e5/1e3);document.cookie=`${V}=${e.id}; max-age=${n}; path=/; SameSite=Lax; Secure`}catch{}}function M(){let e=Date.now(),n=ct();if(n&&n.expiresAt>e)return ae({id:n.id,expiresAt:e+6048e5}),n.id;let t=st();return ae({id:t,expiresAt:e+6048e5}),t}async function se(e){if(e.platform!=="shopify")return;let n=e.fetchFn??fetch;try{await n("/cart/update.js",{method:"POST",credentials:"same-origin",headers:{"Content-Type":"application/json"},body:JSON.stringify({attributes:{sm_visitor_id:e.visitorId}})})}catch{}}var E=[200,500],ce=e=>new Promise(n=>setTimeout(n,e));async function q(e,n){let t;for(let o=0;o<=E.length;o++)try{let i=await fetch(e,n);if(i.status>=500&&o<E.length){await ce(E[o]??0);continue}return i}catch(i){if(t=i,o<E.length){await ce(E[o]??0);continue}throw i}throw t}async function le(e){try{let n=M(),t=await q(`${e.apiBase}/v1/install`,{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify({merchantId:e.merchantId,domain:e.domain,userAgent:navigator.userAgent,referrer:document.referrer||null})});if(!t.ok)return{kind:"err",reason:`install_${t.status}`};let o=await t.json();se({visitorId:n,platform:o.platform??"custom"});let i=await q(`${e.apiBase}/v1/session`,{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify({merchantId:e.merchantId,domain:e.domain})});if(!i.ok)return{kind:"err",reason:`session_${i.status}`};let r=await i.json(),a=null;try{let s=await q(`${e.apiBase}/v1/voice/token`,{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify({sessionId:r.sessionId,merchantId:e.merchantId,visitorId:n})});s.ok?a=await s.json():console.warn("[shoppingmate] voice unavailable \u2014 status",s.status)}catch(s){console.warn("[shoppingmate] voice unavailable \u2014",s)}return{kind:"ok",sessionId:r.sessionId,wsUrl:r.wsUrl,merchantStatus:o.status,personaId:o.personaId??a?.personaId??null,voice:a,visitorId:n}}catch(n){return{kind:"err",reason:n instanceof Error?n.message:"network"}}}function de(e){let n=0,t=a=>{let s=Date.now();s-n<200||(n=s,e.send(a))},o=a=>{let s=a.target;if(!s)return;let c=lt(s),d=c?dt(c,e.hints):null;t({type:"visitor_action",sessionId:e.sessionId,action:"click",intentKey:d,url:window.location.href,elementLabel:c,timestamp:Date.now()})},i=()=>{t({type:"visitor_action",sessionId:e.sessionId,action:"route_change",intentKey:null,url:window.location.href,elementLabel:null,timestamp:Date.now()})},r=a=>{let s=a.target;if(!s)return;let c=s.tagName?.toLowerCase();c!=="input"&&c!=="textarea"&&c!=="select"||s.type==="password"||t({type:"visitor_action",sessionId:e.sessionId,action:"form_focus",intentKey:null,url:window.location.href,elementLabel:s.name||s.id||null,timestamp:Date.now()})};return document.addEventListener("click",o,{passive:!0,capture:!0}),window.addEventListener("popstate",i),document.addEventListener("focusin",r,{passive:!0}),()=>{document.removeEventListener("click",o,!0),window.removeEventListener("popstate",i),document.removeEventListener("focusin",r)}}function lt(e){return e.getAttribute("aria-label")??e.getAttribute("title")??(e.textContent??"").trim().slice(0,80)??null}function dt(e,n){let t=e.toLowerCase();if(n.has(t))return t;for(let o of n.keys())if(t.includes(o)||o.includes(t))return o;return null}var pt=new Set(["the","a","an","to","of","on","in","and","or","section","button","link","card","tile","now"]),ut=[{keyword:"button",matchTag:/^(button)$/i,matchRole:"button"},{keyword:"link",matchTag:/^(a)$/i,matchRole:"link"},{keyword:"card",matchTag:/^(article|div|section)$/i},{keyword:"section",matchTag:/^(section|main|article)$/i}],mt=.4;function C(e,n){if(n){let r=n.get(e.toLowerCase().trim());if(r)try{let a=document.querySelector(r);if(a instanceof HTMLElement&&U(a))return a}catch{}}let t=I(e);if(t.size===0)return null;let o=gt(document.body),i=null;for(let r of o){if(!r.visible)continue;let a=ht(r,e,t);a<mt||(!i||a>i.score)&&(i={c:r,score:a})}return i?.c.element??null}function I(e){return new Set(e.toLowerCase().replace(/[^a-z0-9 ]/g," ").split(/\s+/).filter(n=>n.length>0&&!pt.has(n)))}function gt(e){let n=[],t=document.createTreeWalker(e,NodeFilter.SHOW_ELEMENT),o=t.nextNode();for(;o;){if(o instanceof HTMLElement){let i=ft(o);i&&n.push({element:o,role:o.getAttribute("role")??o.tagName.toLowerCase(),name:i,visible:U(o)})}o=t.nextNode()}return n}function ft(e){let n=e.getAttribute("aria-labelledby");if(n){let r=n.split(/\s+/).map(a=>document.getElementById(a)?.textContent?.trim()??"").filter(Boolean);if(r.length>0)return r.join(" ")}let t=e.getAttribute("aria-label");if(t)return t.trim();if(e.id){let r=document.querySelector(`label[for="${ue(e.id)}"]`);if(r?.textContent)return r.textContent.trim()}let o=e.getAttribute("alt")??e.getAttribute("title");if(o)return o.trim();let i=(e.textContent??"").trim();return i&&i.length<200?i:""}function U(e){if(!e.isConnected)return!1;let n=e.ownerDocument.defaultView?.getComputedStyle(e);return n?!(n.display==="none"||n.visibility==="hidden"||n.opacity==="0"):!0}function ht(e,n,t){let o=I(e.name);if(o.size===0)return 0;let i=0;for(let l of t)o.has(l)&&i++;let r=new Set([...t,...o]).size,a=r===0?0:i/r,s=0,c=n.toLowerCase();for(let l of ut)if(c.includes(l.keyword)&&(l.matchTag.test(e.element.tagName)||e.role===l.matchRole)){s=.15;break}let d=e.element.getAttribute("data-tour-stop"),u=0;if(d){let l=I(d.replace(/-/g," ")),m=0;for(let h of t)l.has(h)&&m++;m>0&&(u=.5*(m/t.size))}return Math.min(1,a+s+u)}function ue(e){return e.replace(/(["\\])/g,"\\$1")}function j(e,n){if(n){let r=n.get(e.toLowerCase().trim());if(r)try{let a=document.querySelector(r);if(a instanceof HTMLElement&&U(a))return a}catch{}}let t=I(e);if(t.size===0)return null;let o=Array.from(document.querySelectorAll("input, textarea, select")).filter(r=>U(r)&&!yt(r)),i=null;for(let r of o){let a=xt(r,t);a<=0||(!i||a>i.score)&&(i={el:r,score:a})}return i?.el??null}function yt(e){let n=(e.getAttribute("type")??"").toLowerCase();return n==="hidden"||n==="submit"||n==="button"||e.disabled}function bt(e){let n=[],t=e.id;if(t){n.push(t);let c=document.querySelector(`label[for="${ue(t)}"]`);c?.textContent&&n.push(c.textContent)}let o=e.getAttribute("name");o&&n.push(o);let i=e.getAttribute("data-field")??e.getAttribute("data-testid");i&&n.push(i);let r=e.getAttribute("aria-label");r&&n.push(r);let a=e.getAttribute("placeholder");a&&n.push(a);let s=e.closest("label");return s?.textContent&&n.push(s.textContent),n}var vt=[["phone","mobile","cell","contact","phonenumber","tel","whatsapp"],["pincode","pin","postal","postcode","zip","zipcode"],["name","fullname"],["email","mail","emailaddress"],["address","street","addr","address1"],["city","town"],["state","province","region"],["landmark","apartment","flat","floor"]],me=new Map;for(let e of vt)for(let n of e)me.set(n,e[0]);function pe(e){return me.get(e)??e}function xt(e,n){let t=new Set([...n].map(pe)),o=0;for(let i of bt(e)){let r=new Set([...I(i)].map(pe));if(r.size===0)continue;let a=0;for(let c of t)r.has(c)&&a++;if(a===0)continue;let s=a/t.size;s>o&&(o=s)}return o}var kt="data-shoppingmate-bot-cursor",ge="data-shoppingmate-cursor-keyframes",L=null,G=window.innerWidth-80,Y=window.innerHeight-80;function fe(){if(L&&L.isConnected)return L;wt();let e=document.createElement("div");return e.setAttribute(kt,""),e.innerHTML=`
  ...
  `,Object.assign(e.style,{position:"fixed",left:"0",top:"0",transform:`translate(${G}px, ${Y}px)`,transition:"transform 480ms cubic-bezier(0.22, 1, 0.36, 1), opacity 200ms",pointerEvents:"none",zIndex:"2147483647",opacity:"0",willChange:"transform, opacity",filter:"drop-shadow(0 2px 6px rgba(0,0,0,0.25))"}),document.body.appendChild(e),L=e,e}function wt(){if(document.head.querySelector(`style[${ge}]`))return;let e=document.createElement("style");e.setAttribute(ge,""),e.textContent=`
